...
use crate::context::TerminalInstructions;
...
impl Session {
    ...
    pub(crate) async fn build_initial_context(
        ...
        if matches!(&session_source, SessionSource::Cli | SessionSource::Exec) {
            developer_sections.push(TerminalInstructions.render());
        }
